...
API_ID = int(environ['22793769'])
API_HASH = environ['2ff2e6f5e98a9ade64d7508830ac9ac0']
BOT_TOKEN = environ['6878600164:AAGul5d6ABpD43b-iOFaxslNbwBx_-B6N5A']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('7029008504, '').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI mongodb+srv://ravikantsharma2261@cluster0.jwadlb7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', "")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL',-1002246260328))
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'https://instantlinks.co/
') #Always use website url from api section 
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '9b6a8cc9a7e5100a8e3075e99ff06f65e549bf31')
